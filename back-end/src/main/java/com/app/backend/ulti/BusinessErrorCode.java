...
public class BusinessErrorCode {
    ...
    public static ErrorCode ACCOUNT_NOT_FOUND = new ErrorCode(HttpStatus.UNAUTHORIZED, "account not found");
    public static ErrorCode ACCOUNT_ALREADY_EXIST = new ErrorCode(HttpStatus.BAD_REQUEST, "account already exist");
    public static ErrorCode PASSWORD_WRONG = new ErrorCode(HttpStatus.UNAUTHORIZED, "wrong password");
    public static ErrorCode IVALID_TOKEN = new ErrorCode(HttpStatus.UNAUTHORIZED, "invalid token");
